            ...
            <div className="flex items-center justify-between h-16 px-4 border-b">
              <div className="flex items-center space-x-3">
                ...
                <div className="min-w-0 flex-1">
                  <h1 className="text-sm font-bold text-gray-900 truncate">{dadosBarbearia.nome}</h1>
              ...
              <div className="space-y-1">
                {navigationItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <Icon className={`${
                        activeTab === item.id ? 'text-yellow-500' : 'text-gray-400 group-hover:text-gray-500'
                      } mr-3 h-5 w-5`} />
                      {item.label}
                    </button>
                  );
                                    ...
                                    for (let day = 1; day <= lastDay.getDate(); day++) {
                                      ...
                                      days.push(
                                        <button
                                          ...
                                          className={`p-1 sm:p-2 text-xs sm:text-sm rounded-lg transition-colors relative ${
                                            isSelected
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div>
                              ...
                              <p className={`text-lg font-semibold ${
                                dadosBarbearia.plano === 'STANDARD' ? 'text-green-600' : 
